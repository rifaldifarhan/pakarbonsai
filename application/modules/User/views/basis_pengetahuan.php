            ...
            <div class="col-lg-12">
              <div class="p-5">
                ...
                <div class="judul_hasil text-center mb-2">
                  <h5 class="text-gray-900 font-weight-bold">Nama Penyakit</h5>
                </div>
                ...
                <div class="text-isi">
                  <h6 class="text-gray-700">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Architecto dignissimos eveniet tenetur nostrum beatae corrupti officia nulla rem illo ea, quia aut eaque tempore fugiat, at nobis ratione, fuga unde!</h6>
                </div>
                <hr>
