<?php echo form_open_multipart('Admin/Gejala/insert'); ?>
            ...
            <div class="card border-left-primary shadow mb-4">
                <div class="card-body w-100">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="id_gejala" id="id_gejala" placeholder="" required />
                    </div>

                    <div class="form-group">
                        <label for="id">Nama Gejala </label>
                        <input class="form-control" type="text" name="nama_gejala" id="nama_gejala" placeholder="" required />
                    </div>
